...
var routes = [
  {
    path: "wizard",
    loadComponent: () => import("./wizard.component-E7P7BTUA.js").then((c) => c.WizardComponent)
  },
  {
    path: "",
    pathMatch: "full",
    canActivate: [canActivateLanding],
    loadComponent: () => import("./landing.component-4FQUBETE.js").then((c) => c.LandingComponent)
  },
  {
    path: "",
    loadChildren: () => import("./main.module-7IWKF4NY.js").then((m) => m.MainModule)
  },
  {
    path: "factorio",
    redirectTo: "/?s=&v=9"
  ...
  constructor() {
    ...
    this.resetRecipeSettings$ = createEffect(() => this.store.select(getRecipesState).pipe(pairwise(), switchMap((x) => this.actions$.pipe(ofType(
      ...
      for (const recipeId of Object.keys(recipesRaw)) {
        ...
        if ((raw.fuelId != null || raw.moduleIds != null || raw.beacons != null) && after[recipeId].machineId !== before[recipeId].machineId)
