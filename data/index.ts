...
export const data: AppData = {
  mods: [
    ...
    { id: 'seamcp', name: 'MCP - Sea Block', game: Game.Factorio },
    { id: 'seabno', name: 'Brave New OARC - Sea Block', game: Game.Factorio },
    { id: 'sbkbno', name: 'Brave New OARC - Space Block', game: Game.Factorio },
    { id: 'sbk', name: 'Spaceblock', game: Game.Factorio },
    { id: 'sbkm45', name: 'M45 - Spaceblock', game: Game.Factorio },
